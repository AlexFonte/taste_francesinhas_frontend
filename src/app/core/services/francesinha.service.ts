...
import {Francesinha, FrancesinhaProposeRequest, FrancesinhaType} from '../models/francesinha.model';
...
export class FrancesinhaService {
	...
	getAllFrancesinhas(filters: {
		name?: string;
		city?: string;
		type?: FrancesinhaType;
		restaurantId?: number
	}, page: number, size = 10): Observable<FrancesinhasPagedResponse> {
